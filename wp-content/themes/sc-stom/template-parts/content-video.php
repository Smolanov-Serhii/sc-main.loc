...
$post_id = get_the_ID();
?>
<section class="video main-container">
    <div class="video__container ">
        <div class="video__text">
            ...
            <div class="video__title">
                <?php echo get_field('zagolovok_video', $post_id)?>
            </div>
            <div class="video__subtitle">
                <?php echo get_field('podzagolovok_video', $post_id)?>
            </div>
            <div class="video__buttons">
                <div class="video__button button button-white js-form">
                    <span><?php echo get_field('button_video', $post_id)?></span>
                </div>
            </div>
        </div>
        <div class="video__video">
            <div class="video__preview" style="position: relative; width: 100%; height: 100%;">
                <img src="<?php echo get_field('privyu_dlya_video', $post_id)?>" alt="Видео превью" style="width: 100%; height: 100%; object-fit: cover;">
            </div>
            <video id="custom-video" width="100%" height="100%" style="display: none;" preload="metadata">
                <source src="<?php echo get_field('video_fajl', $post_id)?>" type="video/mp4">
